...
<!-- End Sidebar-->
  ...
  <main id="main" class="main">
      <div class="pagetitle">
      <h1>Developers Customization (Custom Skill) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_Customization.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
...
&nbsp;| Trạng Thái Kích Hoạt: <?php echo $Config['developer_customization']['active'] ? '<p class="text-success" title="Developers Customization đang được kích hoạt">&nbsp;Đang Bật</p>' : '<p class="text-danger" title="Developers Customization không được kích hoạt">&nbsp;Đang Tắt</p>'; ?>
    ...
    <?php
	$file_path = $VBot_Offline.'Dev_Customization.py';
