...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers Logs (Custom Logs) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_Logs.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_Logs.py</li>
          &nbsp;| Trạng Thái Kích Hoạt:
          <?php
          if (isset($Config['smart_config']['show_log']['log_display_style']) && $Config['smart_config']['show_log']['log_display_style'] === 'dev_custom') {
            echo '<p class="text-success" title="Developers Logs đang được kích hoạt">&nbsp;Đang Bật</p>';
          } else {
            echo '<p class="text-danger" title="Developers Logs không được kích hoạt">&nbsp;Đang Tắt</p>';
          }
          ?>
        </ol>
      </nav>
    ...
    <?php
    $file_path = $VBot_Offline . 'Dev_Logs.py';
...
Để Bật Tắt Sử Dụng Chức Năng Này Hãy Đi Tới: <b>Cấu Hình Config</b> -> <b>Log Hệ Thống</b> -> <b>Kiểu hiển Thị Logs</b> -> <b>dev_custom (Dev_Logs.py Người Dùng Tự Code)</b>
</div>
    </form>
  </main>
  <!-- ======= Footer ======= -->
