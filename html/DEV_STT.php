...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers Speak To Text (STT) (Custom STT) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_STT.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_STT.py</li>
          &nbsp;| Trạng Thái Kích Hoạt: <?php echo $Config['smart_config']['smart_wakeup']['speak_to_text']['stt_select'] === 'stt_dev' ? '<p class="text-success" title="Developers Speak To Text (STT) đang được kích hoạt">&nbsp;Đang Bật</p>' : '<p class="text-danger" title="Developers Speak To Text (STT) không được kích hoạt">&nbsp;Đang Tắt</p>'; ?>
        </ol>
      </nav>
    </div>
    <?php
    $file_path = $VBot_Offline . 'Dev_STT.py';
