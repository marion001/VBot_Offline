...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers Weather (Custom Weather) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_Weather.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_Weather.py</li>
          &nbsp;| Trạng Thái Kích Hoạt:
			<?php
			if (isset($Config['weather']['source']) && $Config['weather']['source'] == 'dev_weather') {
				echo '<p class="text-success" title="Dev_Weather đang được kích hoạt">&nbsp;Đang Bật</p>';
			} else {
				echo '<p class="text-danger" title="Dev_Weather không được kích hoạt">&nbsp;Đang Tắt</p>';
			}
			?>
        </ol>
      </nav>
    ...
    <?php
    $file_path = $VBot_Offline . 'Dev_Weather.py';
...
Để Bật Tắt Sử Dụng Chức Năng Này Hãy Đi Tới: <b>Cấu Hình Config</b> -> <b>Cấu Hình Thời Tiết, Weather</b> -> <b>DEV Custom Music: Dev_Weather.py (Người Dùng Tự Code) </b> -> <b>Kích Hoạt</b>
    </form>
  </main>
  <!-- ======= Footer ======= -->
  <?php
