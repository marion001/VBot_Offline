...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers DEV Processing (Custom Processing - Xử Lý Chính) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_Processing.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_Processing.py</li>
          &nbsp;| Trạng Thái Kích Hoạt: <?php echo $Config['launch_source'] === 'DEV_Processing' ? '<p class="text-success" title="DEV Custom Processing - Xử Lý Chính đang được kích hoạt">&nbsp;Đang Bật</p>' : '<p class="text-danger" title="DEV Custom Processing - Xử Lý Chính không được kích hoạt">&nbsp;Đang Tắt</p>'; ?>
        </ol>
      </nav>
    </div>
    <?php
    $file_path = $VBot_Offline . 'Dev_Processing.py';
