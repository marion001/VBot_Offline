...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers Music (Custom Music Player) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_Music.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_Music.py</li>
          &nbsp;| Trạng Thái Kích Hoạt:
          <?php
          if (isset($Config['media_player']['dev_custom_music']['active'])) {
            echo '<p class="text-success" title="Developers Music đang được kích hoạt">&nbsp;Đang Bật</p>';
          } else {
            echo '<p class="text-danger" title="Developers Music không được kích hoạt">&nbsp;Đang Tắt</p>';
          }
          ?>
        </ol>
      </nav>
    ...
    <?php
    $file_path = $VBot_Offline . 'Dev_Music.py';
