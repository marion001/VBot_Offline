...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers Text To Speak (TTS) (Custom TTS) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_TTS.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_TTS.py</li>
          &nbsp;| Trạng Thái Kích Hoạt: <?php echo $Config['smart_config']['smart_answer']['text_to_speak']['tts_dev_customize']['active'] ? '<p class="text-success" title="Developers Text To Speak (TTS) đang được kích hoạt">&nbsp;Đang Bật</p>' : '<p class="text-danger" title="Developers Text To Speak (TTS) không được kích hoạt">&nbsp;Đang Tắt</p>'; ?>
        </ol>
      </nav>
    </div>
    <?php
    $file_path = $VBot_Offline . 'Dev_TTS.py';
...
Để Bật Tắt Sử Dụng Chức Năng Này Hãy Đi Tới: <b>Cấu Hình Config</b> -> <b>Chuyển Văn Bản Thành Giọng Nói - Text To Speak (TTS)</b> -> <b>Lựa chọn TTS (Text To Speak)</b> -> <b>TTS DEV Customize: Dev_TTS.py (Người Dùng Tự Code)</b> -> <b>Kích Hoạt</b>
</div>
    </form>
  </main>
  <!-- ======= Footer ======= -->
