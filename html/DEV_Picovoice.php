...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Developers Picovoce Hotword (Customize Picovoce) <i class="bi bi-question-circle-fill" onclick="show_message('Bạn có thể Code File <b>Dev_Picovoice.py</b> ở trên giao diện WEB, hoặc có thể truy cập bằng SSH vào Server để Code trực tiếp ở trên file')"></i></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item" onclick="loading('show')"><a href="index.php">Trang Chủ</a></li>
          <li class="breadcrumb-item active">Dev_Picovoice.py</li>
          &nbsp;| Trạng Thái Kích Hoạt:
			<?php
			if (isset($Config['smart_config']['smart_wakeup']['hotword']['lang']) && $Config['smart_config']['smart_wakeup']['hotword']['lang'] == 'customize') {
				echo '<p class="text-success" title="Dev_Picovoice đang được kích hoạt">&nbsp;Đang Bật</p>';
			} else {
				echo '<p class="text-danger" title="Dev_Picovoice không được kích hoạt">&nbsp;Đang Tắt</p>';
			}
			?>
        </ol>
      </nav>
    ...
    <?php
    $file_path = $VBot_Offline . 'Dev_Picovoice.py';
...
Để Bật Tắt Sử Dụng Chức Năng Này Hãy Đi Tới: <b>Cấu Hình Config</b> -> <b>Cấu Hình WakeUP Hotword Engine (Từ Đánh Thức) Picovoice/Snowboy</b> -> <b>Chọn Nguồn Đánh Thức: Picovoice/Porcupine</b> -> <b>Chọn: Customize, Người dùng tự tùy chỉnh (Dev_Picovoice.py) </b>
    </form>
  </main>
  <!-- ======= Footer ======= -->
  <?php
