  ...
  <div class="modal-dialog modal-lg modal-dialog-centered"><div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row g-3 mb-3">
        <div class="col-md-6"><label for="irName" class="form-label">Tên câu lệnh </label><input id="irName" class="form-control" maxlength="100" placeholder="Tên câu lệnh, ví dụ: bật điều hòa"></div>
        <div class="col-md-6"><label for="irReply" class="form-label">Câu Phản hồi</label><input id="irReply" class="form-control" maxlength="500" placeholder="Câu phản hồi (không bắt buộc)"></div>
        <div class="col-12"><label for="irNewAction" class="form-label">Chức năng khi nhận</label><select id="irNewAction" class="form-select"></select></div>
      </div>
      <label for="irData" class="form-label">Mã IR đã học</label>
      <textarea id="irData" class="form-control font-monospace" rows="7" readonly placeholder="Dữ liệu học được sẽ xuất hiện ở đây"></textarea>
    </div>
